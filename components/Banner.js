        ...
        return(
            <View style={{ flex: 1, flexDirection: 'column', backgroundColor: 'white' }}>
                ...
                <View style={{ alignItems: 'center', marginTop: 25 }}>
                    <TouchableOpacity style={{ flexDirection: 'row', backgroundColor: '#982ce6', padding: 10, borderRadius: 15, alignItems: 'center', paddingLeft: 25, paddingRight: 27 }}>
                        <Image source={require('../assets/sso/google.png')} style={{ width: 20, height: 20 }} />
                        <Text style={{ fontWeight: 'bold', fontSize: 17, marginLeft: 15, color: '#a1a1a1', alignItems: 'center', color: 'white' }}>Login Dengan Google</Text>
                    </TouchableOpacity>

                    <TouchableOpacity style={{ flexDirection: 'row', backgroundColor: '#982ce6', padding: 10, borderRadius: 15, alignItems: 'center', paddingLeft: 17, paddingRight: 17, marginTop: 20 }}>
                        <Image source={require('../assets/sso/facebook.png')} style={{ width: 20, height: 20 }} />
                        <Text style={{ fontWeight: 'bold', fontSize: 17, marginLeft: 15, color: '#a1a1a1', alignItems: 'center', color: 'white' }}>Login Dengan Facebook</Text>
                    </TouchableOpacity>

                    <TouchableOpacity style={{ flexDirection: 'row', backgroundColor: '#982ce6', padding: 10, borderRadius: 15, alignItems: 'center', paddingLeft: 25, paddingRight: 27, marginTop: 20 }}>
                        <Image source={require('../assets/sso/twitter.png')} style={{ width: 20, height: 20 }} />
                        <Text style={{ fontWeight: 'bold', fontSize: 17, marginLeft: 15, color: '#a1a1a1', alignItems: 'center', color: 'white' }}>Login Dengan Twitter</Text>
                    </TouchableOpacity>

                    <TouchableOpacity style={{ flexDirection: 'row', backgroundColor: '#982ce6', padding: 10, borderRadius: 15, alignItems: 'center', paddingLeft: 58, paddingRight: 58, marginTop: 20 }} onPress={() => this.props.navigation.navigate('Login')}>
                        <Icons name="logo-react" size={20} />
                        <Text style={{ fontWeight: 'bold', fontSize: 17, marginLeft: 15, color: '#a1a1a1', alignItems: 'center', color: 'white' }}>Login Tryout</Text>
                    </TouchableOpacity>
