        ...
        return(
            <View style={{ flex: 1, flexDirection: 'column', backgroundColor: 'white' }}>
                ...
                <View style={{ alignItems: 'center', marginTop: 25 }}>
                    ...
                    <TouchableOpacity style={{ flexDirection: 'row', backgroundColor: '#a6e69e', padding: 10, borderRadius: 15, alignItems: 'center', paddingLeft: 58, paddingRight: 58, marginTop: 20 }} onPress={() => this.props.navigation.navigate('Register')}>
                        <Icons name="logo-react" size={20} />
                        <Text style={{ fontWeight: 'bold', fontSize: 17, marginLeft: 15, color: '#a1a1a1', alignItems: 'center' }}>Daftar Tryout</Text>
                    </TouchableOpacity>
